...
public class CadastroCategoriaController implements Initializable {
    ...
    private final Categoria categoriaDAO = new Categoria();
    ...
    private boolean showFXMLAnchorPaneCadastroCategoriaDialog(Categoria categoria) throws IOException {
        ...
        loader.setLocation(CadastroCategoriaController.class.getResource("../view/FXMLAnchorPaneCadastroCategoriaDialog.fxml"));
